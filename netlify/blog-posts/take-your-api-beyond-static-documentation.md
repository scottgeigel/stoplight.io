---
path: /blog/take-your-api-beyond-static-documentation
tags: []
relatedTags: []
...
meta:
  ...
  robots: 'index, follow'
  title: Take Your API Beyond Static Documentation | Stoplight
  twitter:
    title: Take Your API Beyond Static Documentation | Stoplight
...
In our [API documentation guide](TBD) we highlight Stripe’s API reference. It provides an overview of what is possible, as well as a deep dive into request and response data. However, its most useful feature is hiding in plain sight.
